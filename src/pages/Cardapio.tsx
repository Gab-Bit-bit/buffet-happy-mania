...
export default function Cardapio(){
    ...
    <section className="titulo">
      ...
      <div className="img-container">
        ...
        <img loading="lazy" src="/images-webp/CardápioBuffet/cardapio2.webp" alt="dadinho" />
        <img loading="lazy" src="/images-webp/CardápioBuffet/cardapio3.webp" alt="dadinho" />
        <img loading="lazy" src="/images-webp/CardápioBuffet/cardapio5.webp" alt="dadinho" />
        ...
        <img loading="lazy" src="/images-webp/CardápioBuffet/cardapio13.webp" alt="dadinho" />
        <img loading="lazy" src="/images-webp/CardápioBuffet/cardapio23.webp" alt="dadinho" />
        <img loading="lazy" src="/images-webp/CardápioBuffet/cardapio14.webp" alt="dadinho" />
        <img loading="lazy" src="/images-webp/CardápioBuffet/cardapio19.webp" alt="dadinho" />
        <img loading="lazy" src="/images-webp/CardápioBuffet/cardapio20.webp" alt="dadinho" />
      </div>
    </section>
  );
};